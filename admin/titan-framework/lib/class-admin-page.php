...
class TitanFrameworkAdminPage {
	...
	private $defaultSettings = array(
		...
		'icon' => 'dashicons-screenoptions', // Menu icon for top level menus only http://melchoyce.github.io/dashicons/
	...
	public function addTitanCreditText() {
		return __( "&nbsp;Спасибо, что выбрали тему от GoodwinPress.", 'gpress' );
	}
	...
	public function createAdminPage() {
		...
		if ( ! empty( $_GET['message'] ) ) {
			if ( $_GET['message'] == 'saved' ) {
				echo TitanFrameworkAdminNotification::formNotification( __( 'Настройки сохранены.', 'gpress' ), esc_html( $_GET['message'] ) );
			} else if ( $_GET['message'] == 'reset' ) {
				echo TitanFrameworkAdminNotification::formNotification( __( 'Настройки сброшены.', 'gpress' ), esc_html( $_GET['message'] ) );
			}
		}
